...
`}function v(){return`// ./src/app.vv.ts
...
`}function m(){return`<!-- ./src/pages/b.vue -->
...
`}function f(){return`<!-- ./src/components/Counter.vue -->
...
`}function g(){return`// ./src/fontAwesomePro.ts
...
`}function b(){return`// ./tests/components/HelloVueVentus.test.js
...
`}function k(){return`<!-- ./src/components/HelloVueVentus.vue -->
...
`}function y(){return`<!-- ./src/components/HelloWorld.vue -->
...
`}function C(){return`<!DOCTYPE html>
<html lang="en">
...
`}function S(){return`<!-- ./src/components/MousePos.vue -->
...
`}function T(){return`// ./src/store/root.ts
...
`}function F(){return`/* ./src/css/prism-theme-vars.css */

@import "prism-theme-vars/base.css";

`}function n(e=!1){return`// ./tailwind.config.cjs
...
`}function B(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function i(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const H=!1;function j(){return i(H)}function A(){return JSON.stringify(j(),null,2)}const M=!0;function I(){return i(M)}function E(){return JSON.stringify(I(),null,2)}function z(){return`// ./vitest.config.ts
...
`}function L(){return`<!-- ./src/components/vv/anchors/VvAnchor.vue -->
...
`}function R(){return`<!-- ./src/components/vv/buttons/VvButton.vue -->
...
`}function D(){return`<!-- ./src/components/vv/inputs/VvCheckbox.vue -->
...
`}function U(){return`<!-- ./src/components/vv/buttons/VvColorModeButton.vue -->
...
`}function G(){return`<!-- ./src/components/vv/elements/VvEl.vue -->
...
`}function o(){return`<!-- ./src/components/vv/elements/VvFa.vue -->
...
`}function q(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function J(){return`<!-- ./src/components/vv/elements/VvPrismVars.vue -->
...
`}function N(){return`<!-- ./src/components/vv/elements/VvPrism.vue -->
...
`}function O(){return`<!-- ./src/components/vv/inputs/VvRadio.vue -->
...
`}function _(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function Y(){return`<!-- ./src/components/vv/textareas/VvTextarea.vue -->
...
`}let r={appVvTs:{name:"app.vv.ts",checked:!0,path:"/src/",src:v()},appColorsJson:{name:"app.colors.json",checked:!0,path:"/src/",src:p()},indexHtml:{name:"index.html",checked:!0,path:"/",src:C()},postCssConfigCjs:{name:"postcss.config.cjs",checked:!0,path:"/",src:P()},tailwindCss:{name:"tailwind.css",checked:!0,path:"/src/css/",src:B()}},$={appVue:{name:"App.vue",checked:!0,path:"/src/",src:c()},helloWorldVue:{name:"HelloWorld.vue",checked:!0,path:"/src/components/",src:y()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:n(!1)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:A()}},K={appVue:{name:"App.vue",checked:!0,path:"/src/",src:u()},aMd:{name:"a.md",checked:!0,path:"/src/pages/",src:l()},bMd:{name:"b.md",checked:!0,path:"/src/pages/",src:d()},bVue:{name:"b.vue",checked:!0,path:"/src/pages/nested/deep/",src:m()},counterVue:{name:"Counter.vue",checked:!0,path:"/src/components/",src:f()},helloWorldVueSsg:{name:"HelloWorld.vue",checked:!0,path:"/src/components/",src:w()},indexMd:{name:"index.md",checked:!0,path:"/src/pages/",src:x()},mousePosVue:{name:"MousePos.vue",checked:!0,path:"/src/components/",src:S()},piniaRootTs:{name:"root.ts",checked:!0,path:"/src/store/",src:T()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:n(!0)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:E()}},s={vvAnchorVue:{name:"VvAnchor.vue",checked:!0,path:"/src/components/vv/anchors/",src:L()},vvButtonVue:{name:"VvButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:R()},vvCheckboxVue:{name:"VvCheckbox.vue",checked:!0,path:"/src/components/vv/inputs/",src:D()},vvColorModeButtonVue:{name:"VvColorModeButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:U()},vvElVue:{name:"VvEl.vue",checked:!0,path:"/src/components/vv/elements/",src:G()},vvInputVue:{name:"VvInput.vue",checked:!0,path:"/src/components/vv/inputs/",src:q()},vvListItemVue:{name:"VvListItem.vue",checked:!0,path:"/src/components/vv/lists/",src:W()},vvRadioVue:{name:"VvRadio.vue",checked:!0,path:"/src/components/vv/inputs/",src:O()},vvTextareaVue:{name:"VvTextarea.vue",checked:!0,path:"/src/components/vv/textareas/",src:Y()}},a={fontawesome:{checked:!0,name:"FontAwesome Free",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/free-solid-svg-icons @fortawesome/free-regular-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/free-solid-svg-icons","@fortawesome/free-regular-svg-icons"],files:{fontAwesomeTs:{name:"fontAwesome.ts",checked:!0,path:"/src/",src:h()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:o()}}},faPro:{checked:!1,name:"FontAwesome Pro (License Required)",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/pro-duotone-svg-icons @fortawesome/pro-light-svg-icons @fortawesome/pro-regular-svg-icons @fortawesome/pro-solid-svg-icons @fortawesome/pro-thin-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/pro-solid-svg-icons","@fortawesome/pro-regular-svg-icons","@fortawesome/pro-duotone-svg-icons","@fortawesome/pro-light-svg-icons","@fortawesome/pro-thin-svg-icons"],files:{fontAwesomeProTs:{name:"fontAwesomePro.ts",checked:!0,path:"/src/",src:g()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:o()}}},gsap:{checked:!0,name:"GSAP",install:"npm install gsap --save-dev",packages:["gsap"],files:{gsapTs:{name:"gsap.ts",checked:!0,path:"/src/",src:V()},vvScrollUp:{name:"VvScrollUp.vue",checked:!0,path:"/src/components/vv/buttons/",src:_()}}},headless:{checked:!0,name:"Headless UI",install:"npm install @headlessui/vue --save-dev",packages:["@headlessui/vue"],files:{}},heroicons:{checked:!0,name:"Heroicons",install:"npm install @heroicons/vue --save-dev",packages:["@heroicons/vue"],files:{}},prism:{checked:!0,name:"Prism.js",install:"npm install prismjs vite-plugin-prismjs @types/prismjs prism-theme-vars --save-dev",packages:["prismjs","vite-plugin-prismjs","@types/prismjs","prism-theme-vars"],files:{vvPrism:{name:"VvPrism.vue",checked:!0,path:"/src/components/vv/elements/",src:N()},prismThemeVarsCss:{name:"prism-theme-vars.css",checked:!0,path:"/src/css/",src:F()},VvPrismVars:{name:"VvPrismVars.vue",checked:!0,path:"/src/components/vv/elements/",src:J()}}},vitest:{checked:!0,name:"Vitest",install:"npm install vitest @vue/test-utils happy-dom @vitest/coverage-c8 --save-dev",packages:["vitest","@vue/test-utils","happy-dom","@vitest/coverage-c8"],files:{vitestConfigTs:{name:"vitest.config.ts",checked:!0,path:"/",src:z()},helloVueVentusTestJs:{name:"HelloVueVentus.test.js",checked:!0,path:"/tests/components/",src:b()},helloVueVentusVue:{name:"HelloVueVentus.vue",checked:!0,path:"/src/components/",src:k()}}}};const X={stacks:{vueTwViteTs:{name:"Vue 3, Tailwind CSS, Vite & Typescript",files:{...r,...$},deps:{...a},compos:{...s}},vueTwViteSsgMdTs:{name:"Vite-SSG, Vue 3, Tailwind CSS, Pinia, Markdown & Typescript",files:{...r,...K},deps:{...a},compos:{...s}}}};export{X as c};
