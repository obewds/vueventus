const d={vueTwViteTs:"Vue 3, Tailwind CSS, Headless UI, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Headless UI, Pinia, Markdown, Auto-Loading & Typescript",vueTwNuxt3:"Vue 3, Nuxt 3, Nuxt Content, Tailwind CSS, Headless UI, Pinia, & Typescript"};function D(){return`---
title: Page A
meta:
  - name: description
...
`}function h(e=""){return`<!-- ./src/pages/${e}.vue -->
...
`}function ve(){return h("[...all]")}function me(){return`<!-- ./src/components/Counter.vue -->
...
`}function fe(){return`// ./src/fontAwesomePro.ts
...
`}function ge(){return`// ./src/fontawesome.ts
...
`}function be(){return`// ./src/gsap.ts
...
`}function he(){return`// ./tests/components/HelloVueVentus.test.js
...
`}function xe(){return`<!-- ./src/components/HelloVueVentus.vue -->
...
`}function Ve(){return`<!-- ./src/components/HelloWorld.vue -->
...
`}function ye(){return`<!-- ./src/pages/Home.vue -->
...
`}function ke(){return`<!DOCTYPE html>
<html lang="en">
...
`}function Se(){return h("NotFound404")}function Te(){return`// ./src/store/root.ts
...
`}function Pe(){return`// ./postcss.config.cjs
...
`}function Fe(){return`/* ./src/css/prism-theme-vars.css */

@import "prism-theme-vars/base.css";

`}function ze(){return`// ./src/router/routes.ts
...
`}function Be(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function V(e=!1){let o=["node","vite/client"];return e===!0&&o.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:o,paths:{"@/":["/src"]}}}}const Le=!1;function De(){return V(Le)}function je(){return JSON.stringify(De(),null,2)}const Re=!0;function Ge(){return V(Re)}function He(){return JSON.stringify(Ge(),null,2)}function Ie(){return`// ./vitest.config.ts
...
`}function Me(e=!1){return`<!-- ${e?"./components/Vv/Anchor.vue":"./src/components/vv/anchors/VvAnchor.vue"} -->
...
`}function Ae(){return`<!-- ./src/components/vv/buttons/VvButton.vue -->
...
`}function Ee(){return`<!-- ./src/components/vv/inputs/VvCheckbox.vue -->
...
`}function $e(){return`<!-- ./src/components/vv/buttons/VvColorModeButton.vue -->
...
`}function Oe(){return`<!-- ./src/components/vv/elements/VvEl.vue -->
...
`}function k(){return y(!1)}function C(){return y(!0)}function Ue(){return`<!-- ./src/components/vv/forms/VvFormGroup.vue -->
...
`}function Je(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function Ne(){return`<!-- ./src/components/vv/lists/VvListItem.vue -->
...
`}function qe(){return`<!-- ./src/components/vv/elements/VvPrismVars.vue -->
...
`}function _e(){return`<!-- ./src/components/vv/elements/VvPrism.vue -->
...
`}function Ye(){return`<!-- ./src/components/vv/forms/VvQuadFormGroup.vue -->
...
`}function Xe(){return`<!-- ./src/components/vv/inputs/VvRadio.vue -->
...
`}function Ze(){return`<!-- ./src/components/vv/anchors/VvRouterLink.vue -->
...
`}function Ke(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function et(){return`<!-- ./src/components/vv/selects/VvSelect.vue -->
...
`}function tt(){return`<!-- ./src/components/vv/textareas/VvTextarea.vue -->
...
`}function ot(){return`// ./tests/pages/b.test.js
...
`}function st(){return`// ./tests/pages/Home.test.js
...
`}function rt(){return`// ./tests/pages/NotFound404.test.js
...
`}function at(e=!1){let o=e?"../../../../":"../../../../src/";return`// ./tests/components/vv/anchors/VvAnchor.test.js
...
`}function lt(){return`// ./tests/components/vv/buttons/VvButton.test.js
...
`}function pt(){return`// ./tests/components/vv/inputs/VvCheckbox.test.js
...
`}function nt(){return`// ./tests/components/vv/buttons/VvColorModeButton.test.js
...
`}function it(){return`// ./tests/components/vv/elements/VvEl.test.js
...
`}function w(e=!1){let o="import '../../../../src/fontAwesome'";return e===!0&&(o="import '../../../../src/fontAwesomePro'"),`// ./tests/components/vv/elements/VvFa.test.js
...
`}function ut(){return w(!1)}function ct(){return w(!0)}function dt(){return`// ./tests/components/vv/forms/VvFormGroup.test.js
...
`}function vt(){return`// ./tests/components/vv/inputs/VvInput.test.js
...
`}function mt(){return`// ./tests/components/vv/lists/VvList.test.js
...
`}function ft(){return`// ./tests/components/vv/selects/VvListbox.test.js
...
`}function gt(){return`// ./tests/components/vv/lists/VvListItem.test.js
...
`}function bt(){return`// ./tests/components/vv/elements/VvPrism.test.js
...
`}function ht(){return`// ./tests/components/vv/elements/VvPrismVars.test.js
...
`}function xt(){return`// ./tests/components/vv/forms/VvQuadFormGroup.test.js
...
`}function Vt(){return`// ./tests/components/vv/inputs/VvRadio.test.js
...
`}function yt(){return`// ./tests/components/vv/anchors/VvRouterLink.test.js
...
`}function kt(){return`// ./tests/components/vv/buttons/VvScrollUp.test.js
...
`}function Ct(){return`// ./tests/components/vv/selects/VvSelect.test.js
...
`}function wt(){return`// ./tests/components/vv/textareas/VvTextarea.test.js
...
`}let f={appVvTs:{name:"app.vv.ts",checked:!0,path:"/src/",src:ue()},appColorsJson:{name:"app.colors.json",checked:!0,path:"/src/",src:j()},indexHtml:{name:"index.html",checked:!0,path:"/",src:ke()},postCssConfigCjs:{name:"postcss.config.cjs",checked:!0,path:"/",src:Pe()},tailwindCss:{name:"tailwind.css",checked:!0,path:"/src/css/",src:Be()}},St={appVue:{name:"App.vue",checked:!0,path:"/src/",src:R()},homeVue:{name:"Home.vue",checked:!0,path:"/src/pages/",src:ye()},notFound404Vue:{name:"NotFound404.vue",checked:!0,path:"/src/pages/",src:Se()},routesTs:{name:"routes.ts",checked:!0,path:"/src/router/",src:ze()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:x(!1)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:je()}},Tt={appVue:{name:"App.vue",checked:!0,path:"/src/",src:G()},aMd:{name:"a.md",checked:!0,path:"/src/pages/",src:D()},bMd:{name:"b.md",checked:!0,path:"/src/pages/",src:ce()},bVue:{name:"b.vue",checked:!0,path:"/src/pages/nested/deep/",src:de()},catchAll404:{name:"[...all].vue",checked:!0,path:"/src/pages/",src:ve()},counterVue:{name:"Counter.vue",checked:!0,path:"/src/components/",src:me()},helloWorldVueSsg:{name:"HelloWorld.vue",checked:!0,path:"/src/components/",src:Ve()},indexMd:{name:"index.md",checked:!0,path:"/src/pages/",src:Ce()},mousePosVue:{name:"MousePos.vue",checked:!0,path:"/src/components/",src:we()},piniaRootTs:{name:"root.ts",checked:!0,path:"/src/store/",src:Te()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:x(!0)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:He()}},g={vvAnchorVue:{name:"VvAnchor.vue",checked:!0,path:"/src/components/vv/anchors/",src:Me()},vvButtonVue:{name:"VvButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:Ae()},vvCheckboxVue:{name:"VvCheckbox.vue",checked:!0,path:"/src/components/vv/inputs/",src:Ee()},vvColorModeButtonVue:{name:"VvColorModeButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:$e()},vvElVue:{name:"VvEl.vue",checked:!0,path:"/src/components/vv/elements/",src:Oe()},vvFormGroupVue:{name:"VvFormGroup.vue",checked:!0,path:"/src/components/vv/forms/",src:Ue()},vvInputVue:{name:"VvInput.vue",checked:!0,path:"/src/components/vv/inputs/",src:Je()},vvListVue:{name:"VvList.vue",checked:!0,path:"/src/components/vv/lists/",src:Qe()},vvListboxVue:{name:"VvListbox.vue",checked:!0,path:"/src/components/vv/selects/",src:We()},vvListItemVue:{name:"VvListItem.vue",checked:!0,path:"/src/components/vv/lists/",src:Ne()},vvQuadFormGroupVue:{name:"VvQuadFormGroup.vue",checked:!0,path:"/src/components/vv/forms/",src:Ye()},vvRadioVue:{name:"VvRadio.vue",checked:!0,path:"/src/components/vv/inputs/",src:Xe()},vvRouterLinkVue:{name:"VvRouterLink.vue",checked:!0,path:"/src/components/vv/anchors/",src:Ze()},vvSelectVue:{name:"VvSelect.vue",checked:!0,path:"/src/components/vv/selects/",src:et()},vvTextareaVue:{name:"VvTextarea.vue",checked:!0,path:"/src/components/vv/textareas/",src:tt()}},S={checked:!0,name:"FontAwesome Free",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/free-solid-svg-icons @fortawesome/free-regular-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/free-solid-svg-icons","@fortawesome/free-regular-svg-icons"],files:{fontAwesomeTs:{name:"fontAwesome.ts",checked:!0,path:"/src/",src:ge()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:k()},vvFaTestJs:{name:"VvFa.test.js",checked:!0,path:"/tests/components/vv/elements/",src:ut()}}},T=S;T.files.vvFa={name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:C()};let P={checked:!1,name:"FontAwesome Pro (License Required)",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/pro-duotone-svg-icons @fortawesome/pro-light-svg-icons @fortawesome/pro-regular-svg-icons @fortawesome/pro-solid-svg-icons @fortawesome/pro-thin-svg-icons @fortawesome/sharp-solid-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/pro-solid-svg-icons","@fortawesome/pro-regular-svg-icons","@fortawesome/pro-duotone-svg-icons","@fortawesome/pro-light-svg-icons","@fortawesome/pro-thin-svg-icons","@fortawesome/sharp-solid-svg-icons"],files:{fontAwesomeProTs:{name:"fontAwesomePro.ts",checked:!0,path:"/src/",src:fe()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:k()},vvFaTestJs:{name:"VvFa.test.js",checked:!0,path:"/tests/components/vv/elements/",src:ct()}}},F=P;F.files.vvFa={name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:C()};let z={checked:!0,name:"Vitest",install:"npm install vitest @vue/test-utils happy-dom @vitest/coverage-c8 --save-dev",packages:["vitest","@vue/test-utils","happy-dom","@vitest/coverage-c8"],files:{vitestConfigTs:{name:"vitest.config.ts",checked:!0,path:"/",src:Ie()},helloVueVentusTestJs:{name:"HelloVueVentus.test.js",checked:!0,path:"/tests/components/",src:he()},helloVueVentusVue:{name:"HelloVueVentus.vue",checked:!0,path:"/src/components/",src:xe()},vvAnchorTestJs:{name:"VvAnchor.test.js",checked:!0,path:"/tests/components/vv/anchors/",src:at()},vvButtonTestJs:{name:"VvButton.test.js",checked:!0,path:"/tests/components/vv/buttons/",src:lt()},vvCheckboxTestJs:{name:"VvCheckbox.test.js",checked:!0,path:"/tests/components/vv/inputs/",src:pt()},vvColorModeButtonTestJs:{name:"VvColorModeButton.test.js",checked:!0,path:"/tests/components/vv/buttons/",src:nt()},vvElTestJs:{name:"VvEl.test.js",checked:!0,path:"/tests/components/vv/elements/",src:it()},vvFormGroupTestJs:{name:"VvFormGroup.test.js",checked:!0,path:"/tests/components/vv/forms/",src:dt()},vvInputTestJs:{name:"VvInput.test.js",checked:!0,path:"/tests/components/vv/inputs/",src:vt()},vvListTestJs:{name:"VvList.test.js",checked:!0,path:"/tests/components/vv/lists/",src:mt()},vvListboxTestJs:{name:"VvListbox.test.js",checked:!0,path:"/tests/components/vv/selects/",src:ft()},vvListItemTestJs:{name:"VvListItem.test.js",checked:!0,path:"/tests/components/vv/lists/",src:gt()},vvQuadFormGroupTestJs:{name:"VvQuadFormGroup.test.js",checked:!0,path:"/tests/components/vv/forms/",src:xt()},vvRadioTestJs:{name:"VvRadio.test.js",checked:!0,path:"/tests/components/vv/inputs/",src:Vt()},vvRouterLinkTestJs:{name:"VvRouterLink.test.js",checked:!0,path:"/tests/components/vv/anchors/",src:yt()},vvScrollUpTestJs:{name:"VvScrollUp.test.js",checked:!0,path:"/tests/components/vv/buttons/",src:kt()},vvSelectTestJs:{name:"VvSelect.test.js",checked:!0,path:"/tests/components/vv/selects/",src:Ct()},vvTextareaTestJs:{name:"VvTextarea.test.js",checked:!0,path:"/tests/components/vv/textareas/",src:wt()}}},m=z;m.files.homeTestJs={name:"Home.test.js",checked:!0,path:"/tests/pages/",src:st()};m.files.notFound404TestJs={name:"NotFound404.test.js",checked:!0,path:"/tests/pages/",src:rt()};let B=z;B.files.bTestJs={name:"b.test.js",checked:!0,path:"/tests/pages/",src:ot()};let L={fontawesome:{},faPro:{},gsap:{checked:!0,name:"GSAP",install:"npm install gsap --save-dev",packages:["gsap"],files:{gsapTs:{name:"gsap.ts",checked:!0,path:"/src/",src:be()},vvScrollUp:{name:"VvScrollUp.vue",checked:!0,path:"/src/components/vv/buttons/",src:Ke()}}},headless:{checked:!0,name:"Headless UI",install:"npm install @headlessui/vue @headlessui/tailwindcss --save-dev",packages:["@headlessui/vue","@headlessui/tailwindcss"],files:{}},heroicons:{checked:!0,name:"Heroicons",install:"npm install @heroicons/vue --save-dev",packages:["@heroicons/vue"],files:{}},prism:{checked:!0,name:"Prism.js",install:"npm install prismjs vite-plugin-prismjs @types/prismjs prism-theme-vars --save-dev",packages:["prismjs","vite-plugin-prismjs","@types/prismjs","prism-theme-vars"],files:{vvPrism:{name:"VvPrism.vue",checked:!0,path:"/src/components/vv/elements/",src:_e()},prismThemeVarsCss:{name:"prism-theme-vars.css",checked:!0,path:"/src/css/",src:Fe()},vvPrismVars:{name:"VvPrismVars.vue",checked:!0,path:"/src/components/vv/elements/",src:qe()},vvPrismTestJs:{name:"VvPrism.test.js",checked:!0,path:"/tests/components/vv/elements/",src:bt()},vvPrismVarsTestJs:{name:"VvPrismVars.test.js",checked:!0,path:"/tests/components/vv/elements/",src:ht()}}},vitest:{}},n=L;n.fontawesome=S;n.faPro=P;n.vitest=m;let i=L;i.fontawesome=T;i.faPro=F;i.vitest=B;const Pt={stacks:{vueTwViteTs:{name:d.vueTwViteTs,files:{...f,...St},deps:{...n},compos:{...g}},vueTwViteSsgMdTs:{name:d.vueTwViteSsgMdTs,files:{...f,...Tt},deps:{...i},compos:{...g}}}};export{Pt as c};
