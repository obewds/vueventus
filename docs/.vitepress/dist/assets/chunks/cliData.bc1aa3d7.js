...
`}function He(){return`<!-- ./src/components/HelloWorld.vue -->
...
`}function Ge(){return`<!-- ./src/pages/Home.vue -->
...
`}function Ie(){return`<!DOCTYPE html>
<html lang="en">
...
`}function Ae(){return`<!-- ./src/components/MousePos.vue -->
...
`}function Me(){return V("NotFound404")}function $e(){return`<!-- ./pages/index.vue -->

<template>

    <div>

        <p>This is the <samp>./pages/index.vue</samp> page component!</p>
...
`}function Ee(){return`// ./src/store/root.ts
...
`}function Oe(){return`// ./postcss.config.cjs
...
`}function Ue(){return`/* ./src/css/prism-theme-vars.css */

@import "prism-theme-vars/base.css";

`}function Qe(){return`// ./src/router/routes.ts
...
`}function We(){return`// ./tailwind.config.ts
...
`}function qe(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function k(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const Ne=!1;function _e(){return k(Ne)}function Ye(){return JSON.stringify(_e(),null,2)}const Xe=!0;function Ze(){return k(Xe)}function Ke(){return JSON.stringify(Ze(),null,2)}function et(){return`// ./vitest.config.ts
...
`}function S(e=!1){return`<!-- ${e?"./components/Vv/Button.vue":"./src/components/vv/anchors/VvButton.vue"} -->
...
`}function w(e=!1){return`<!-- ${e?"./components/Vv/Checkbox.vue":"./src/components/vv/anchors/VvCheckbox.vue"} -->
...
`}function T(e=!1){return`<!-- ${e?"./components/Vv/ColorModeButton.vue":"./src/components/vv/anchors/VvColorModeButton.vue"} -->
...
`}function P(e=!1){return`<!-- ${e?"./components/Vv/El.vue":"./src/components/vv/anchors/VvEl.vue"} -->
...
`}function F(e=!1){const t=`
    ...
    />
`;let s=t;return e===!0&&(s=t),`<!-- ./src/components/vv/elements/VvFa.vue -->
...
`}function z(){return F(!1)}function L(){return F(!0)}function B(e=!1){return`<!-- ${e?"./components/Vv/FormGroup.vue":"./src/components/vv/anchors/VvFormGroup.vue"} -->
...
`}function j(e=!1){return`<!-- ${e?"./components/Vv/Input.vue":"./src/components/vv/anchors/VvInput.vue"} -->
...
`}function D(e=!1){return`<!-- ${e?"./components/Vv/List.vue":"./src/components/vv/anchors/VvList.vue"} -->
...
`}function R(e=!1){return`<!-- ${e?"./components/Vv/Listbox.vue":"./src/components/vv/anchors/VvListbox.vue"} -->
...
`}function H(e=!1){return`<!-- ${e?"./components/Vv/ListItem.vue":"./src/components/vv/anchors/VvListItem.vue"} -->
...
`}function tt(){return`<!-- ./src/components/vv/elements/VvPrismVars.vue -->
...
`}function ot(){return`<!-- ./src/components/vv/elements/VvPrism.vue -->
...
`}function G(e=!1){return`<!-- ${e?"./components/Vv/QuadFormGroup.vue":"./src/components/vv/anchors/VvQuadFormGroup.vue"} -->
...
`}function I(e=!1){return`<!-- ${e?"./components/Vv/Radio.vue":"./src/components/vv/anchors/VvRadio.vue"} -->
...
`}function st(){return`<!-- ./src/components/vv/anchors/VvRouterLink.vue -->
...
`}function rt(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function J(e=!1){return`<!-- ${e?"./components/Vv/Select.vue":"./src/components/vv/anchors/VvSelect.vue"} -->
...
`}function A(e=!1){return`<!-- ${e?"./components/Vv/Textarea.vue":"./src/components/vv/anchors/VvTextarea.vue"} -->
...
`}function at(){return`// ./tests/pages/b.test.js
...
`}function lt(){return`// ./tests/pages/Home.test.js
...
`}function nt(){return`// ./tests/pages/NotFound404.test.js
...
`}function pt(e=!1){let t=e?"../../../../":"../../../../src/";return`// ./tests/components/vv/anchors/VvAnchor.test.js
...
`}function it(){return`// ./tests/components/vv/buttons/VvButton.test.js
...
`}function ut(){return`// ./tests/components/vv/inputs/VvCheckbox.test.js
...
`}function ct(){return`// ./tests/components/vv/buttons/VvColorModeButton.test.js
...
`}function dt(){return`// ./tests/components/vv/elements/VvEl.test.js
...
`}function M(e=!1){let t="import '../../../../src/fontAwesome'";return e===!0&&(t="import '../../../../src/fontAwesomePro'"),`// ./tests/components/vv/elements/VvFa.test.js
...
`}function vt(){return M(!1)}function mt(){return M(!0)}function ft(){return`// ./tests/components/vv/forms/VvFormGroup.test.js
...
`}function gt(){return`// ./tests/components/vv/inputs/VvInput.test.js
...
`}function bt(){return`// ./tests/components/vv/lists/VvList.test.js
...
`}function ht(){return`// ./tests/components/vv/selects/VvListbox.test.js
...
`}function xt(){return`// ./tests/components/vv/lists/VvListItem.test.js
...
`}function Vt(){return`// ./tests/components/vv/elements/VvPrism.test.js
...
`}function yt(){return`// ./tests/components/vv/elements/VvPrismVars.test.js
...
`}function kt(){return`// ./tests/components/vv/forms/VvQuadFormGroup.test.js
...
`}function Ct(){return`// ./tests/components/vv/inputs/VvRadio.test.js
...
`}function St(){return`// ./tests/components/vv/anchors/VvRouterLink.test.js
...
`}function wt(){return`// ./tests/components/vv/buttons/VvScrollUp.test.js
...
`}function Tt(){return`// ./tests/components/vv/selects/VvSelect.test.js
...
`}function Pt(){return`// ./tests/components/vv/textareas/VvTextarea.test.js
