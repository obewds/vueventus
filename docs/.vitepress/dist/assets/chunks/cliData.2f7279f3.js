const p={vueTwViteTs:"Vue 3, Tailwind CSS, Headless UI, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Headless UI, Pinia, Markdown, Auto-Loading & Typescript",vueTwNuxt3:"Nuxt 3, Vue 3, Tailwind CSS, Headless UI, Pinia, Nuxt Content, & Typescript"};function ae(){return`---
title: Page A
meta:
  - name: description
...
`}function le(){return`<!-- ./src/App.vue -->
...
`}function Ge(){return`<!-- ./src/pages/b.vue -->
...
`}function $e(){return P("[...all]")}function Ee(){return`<!-- ./src/components/Counter.vue -->
...
`}function Me(){return`// ./plugins/fontAwesomePro.ts
...
`}function Je(){return`// ./plugins/fontAwesome.ts
...
`}function Oe(){return`// ./src/gsap.ts
...
`}function Ue(){return`// ./plugins/gsap.js
// https://greensock.com/docs/v3/Installation?checked=core#modules
...
`}function Ne(){return`<!-- ./src/components/HelloVueVentus.vue -->
...
`}function Qe(){return`<!-- ./src/components/HelloWorld.vue -->
...
`}function We(){return`<!-- ./src/pages/Home.vue -->
...
`}function _e(){return`<!DOCTYPE html>
<html lang="en">
...
`}function Xe(){return`<!-- ./src/components/MousePos.vue -->
...
`}function Ze(){return P("NotFound404")}function Ke(){return`// ./public/js/on-page-load-color-modes.js
...
`}function et(){return`<!-- ./pages/index.vue -->
...
`}function tt(){return`// ./src/store/root.ts
...
`}function ot(){return`// ./postcss.config.cjs
...
`}function st(){return`// ./src/router/routes.ts
...
`}function rt(){return`// ./tailwind.config.ts
...
`}function at(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function j(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const lt=!1;function nt(){return j(lt)}function pt(){return JSON.stringify(nt(),null,2)}const it=!0;function ut(){return j(it)}function ct(){return JSON.stringify(ut(),null,2)}function dt(){return`// ./vitest.config.ts
...
`}function D(e=!1){return`<!-- ${e?"./components/Vv/Anchor.vue":"./src/components/vv/anchors/VvAnchor.vue"} -->
...
`}function H(e=!1){return`<!-- ${e?"./components/Vv/Button.vue":"./src/components/vv/buttons/VvButton.vue"} -->
...
`}function I(e=!1){let t=e?"./components/Vv/ColorModeButton.vue":"./src/components/vv/buttons/VvColorModeButton.vue",r=e?"../../app.vv":"../../../app.vv",a=e?"<ClientOnly>":"",l=e?"</ClientOnly>":"",s=e?"    ":"";return`<!-- ${t} -->
...
`}function A(e=!1){return`<!-- ${e?"./components/Vv/El.vue":"./src/components/vv/elements/VvEl.vue"} -->
...
`}function $(){return G(!1)}function E(){return`<!-- ./components/Vv/Fa.vue -->
...
`}function M(){return G(!0)}function J(e=!1){return`<!-- ${e?"./components/Vv/FormGroup.vue":"./src/components/vv/forms/VvFormGroup.vue"} -->
...
`}function O(e=!1){return`<!-- ${e?"./components/Vv/Input.vue":"./src/components/vv/inputs/VvInput.vue"} -->
...
`}function U(e=!1){return`<!-- ${e?"./components/Vv/List.vue":"./src/components/vv/lists/VvList.vue"} -->
...
`}function N(e=!1){return`<!-- ${e?"./components/Vv/ListItem.vue":"./src/components/vv/lists/VvListItem.vue"} -->
...
`}function vt(){return`<!-- ./src/components/vv/anchors/VvNuxtRouterLink.vue -->
    ...
    `}function Q(e=!1){return`<!-- ${e?"./components/Vv/PrismVars.vue":"./src/components/vv/elements/VvPrismVars.vue"} -->
...
`}function W(e=!1){return`<!-- ${e?"./components/Vv/Prism.vue":"./src/components/vv/elements/VvPrism.vue"} -->
...
`}function _(e=!1){return`<!-- ${e?"./components/Vv/QuadFormGroup.vue":"./src/components/vv/forms/VvQuadFormGroup.vue"} -->
...
`}function Y(e=!1){return`<!-- ${e?"./components/Vv/Radio.vue":"./src/components/vv/inputs/VvRadio.vue"} -->
...
`}function X(e=!1){return`<!-- ${e?"./components/Vv/ScrollUp.vue":"./src/components/vv/lists/VvList.vue"} -->
...
`}function Z(e=!1){return`<!-- ${e?"./components/Vv/Select.vue":"./src/components/vv/selects/VvSelect.vue"} -->
...
`}function K(e=!1){return`<!-- ${e?"./components/Vv/Textarea.vue":"./src/components/vv/textareas/VvTextarea.vue"} -->
...
`}function ee(e=!1){let t="import '../../../../src/fontAwesome'";return e===!0&&(t="import '../../../../src/fontAwesomePro'"),`// ./tests/components/vv/elements/VvFa.test.js
...
`}function te(){return ee(!1)}function wt(){return ee(!0)}function Ct(){return`// ./tests/components/vv/forms/VvFormGroup.test.js
