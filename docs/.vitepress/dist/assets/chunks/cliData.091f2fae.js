...
`}function x(){return`// ./src/app.vv.ts
...
`}function T(){return`<!-- ./src/pages/b.vue -->
...
`}function F(){return p("[...all]")}function P(){return`<!-- ./src/components/Counter.vue -->
...
`}function B(){return`// ./src/fontAwesomePro.ts
...
`}function j(){return`// ./tests/components/HelloVueVentus.test.js
...
`}function M(){return`<!-- ./src/components/HelloVueVentus.vue -->
...
`}function I(){return`<!-- ./src/pages/Home.vue -->
...
`}function R(){return`<!DOCTYPE html>
<html lang="en">
...
`}function L(){return`<!-- ./src/components/MousePos.vue -->
...
`}function D(){return p("NotFound404")}function U(){return`// ./src/store/root.ts
...
`}function G(){return`// ./postcss.config.cjs
...
`}function q(){return`/* ./src/css/prism-theme-vars.css */

@import "prism-theme-vars/base.css";

`}function N(){return`// ./src/router/routes.ts
...
`}function u(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const O=!1;function W(){return u(O)}function Y(){return JSON.stringify(W(),null,2)}const _=!0;function $(){return u(_)}function K(){return JSON.stringify($(),null,2)}function Q(){return`// ./vitest.config.ts
...
`}function X(){return`<!-- ./src/components/vv/anchors/VvAnchor.vue -->
...
`}function Z(){return`<!-- ./src/components/vv/buttons/VvButton.vue -->
...
`}function te(){return`<!-- ./src/components/vv/buttons/VvColorModeButton.vue -->
...
`}function d(){return v(!1)}function m(){return v(!0)}function re(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function se(){return`<!-- ./src/components/vv/lists/VvListItem.vue -->
...
`}function ae(){return`<!-- ./src/components/vv/elements/VvPrismVars.vue -->
...
`}function ne(){return`<!-- ./src/components/vv/elements/VvPrism.vue -->
...
`}function pe(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function ce(){return`<!-- ./src/components/vv/textareas/VvTextarea.vue -->
