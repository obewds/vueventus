const r={vueTwViteTs:"Vue 3, Tailwind CSS, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Pinia, Markdown, Auto-Loading & Typescript"};function C(){return`---
title: Page A
meta:
  - name: description
...
`}function u(e=""){return`<!-- ./src/pages/${e}.vue -->
...
`}function A(){return u("[...all]")}function H(){return`<!-- ./src/components/Counter.vue -->
...
`}function I(){return`// ./src/fontawesome.ts
...
`}function L(){return`// ./tests/components/HelloVueVentus.test.js
...
`}function J(){return`<!-- ./src/pages/Home.vue -->
...
`}function D(){return`<!DOCTYPE html>
<html lang="en">
...
`}function N(){return`<!-- ./src/components/MousePos.vue -->
...
`}function G(){return u("NotFound404")}function q(){return`// ./src/store/root.ts
...
`}function O(){return`// ./postcss.config.cjs
...
`}function W(){return`/* ./src/css/prism-theme-vars.css */

@import "prism-theme-vars/base.css";

`}function _(){return`// ./src/router/routes.ts
...
`}function Y(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function v(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const $=!1;function K(){return v($)}function Q(){return JSON.stringify(K(),null,2)}const X=!0;function Z(){return v(X)}function ee(){return JSON.stringify(Z(),null,2)}function te(){return`// ./vitest.config.ts
...
`}function m(e=!1){const t=`
    <FontAwesomeIcon :icon="[family, icon]" :size="size"/>
`,n=`
    <client-only>
        <FontAwesomeIcon :icon="[family, icon]" :size="size"/>
    </client-only>
`;let p=t;return e===!0&&(p=n),`<!-- ./src/components/vv/elements/VvFa.vue -->
...
`}function ie(){return`<!-- ./src/components/vv/lists/VvListItem.vue -->
...
`}function we(){return`// ./tests/components/vv/elements/VvEl.test.js
...
`}function g(e=!1){let t="import '../../../../src/fontAwesome'";return e===!0&&(t="import '../../../../src/fontAwesomePro'"),`// ./tests/components/vv/elements/VvFa.test.js
...
`}function xe(){return g(!1)}function Ce(){return g(!0)}function Se(){return`// ./tests/components/vv/inputs/VvInput.test.js
...
`}function He(){return`// ./tests/components/vv/textareas/VvTextarea.test.js
