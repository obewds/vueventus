...
`}function Fe(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function V(e=!1){let o=["node","vite/client"];return e===!0&&o.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:o,paths:{"@/":["/src"]}}}}const ze=!1;function Le(){return V(ze)}function je(){return JSON.stringify(Le(),null,2)}const De=!0;function Re(){return V(De)}function He(){return JSON.stringify(Re(),null,2)}function Me(){return`// ./vitest.config.ts
...
`}function Ae(){return`<!-- ./src/components/vv/anchors/VvAnchor.vue -->
...
`}function Ie(){return`<!-- ./src/components/vv/buttons/VvButton.vue -->
...
`}function k(){return y(!1)}function w(){return y(!0)}function Ue(){return`<!-- ./src/components/vv/forms/VvFormGroup.vue -->
...
`}function lt(){return`// ./tests/components/vv/elements/VvEl.test.js
...
`}function it(){return C(!1)}function pt(){return C(!0)}function ut(){return`// ./tests/components/vv/forms/VvFormGroup.test.js
