const d={vueTwViteTs:"Vue 3, Tailwind CSS, Headless UI, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Headless UI, Pinia, Markdown, Auto-Loading & Typescript"};function z(){return`---
title: Page A
meta:
  - name: description
...
`}function Pe(){return`// ./src/router/routes.ts
...
`}function V(e=!1){let o=["node","vite/client"];return e===!0&&o.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:o,paths:{"@/":["/src"]}}}}const Le=!1;function je(){return V(Le)}function ze(){return JSON.stringify(je(),null,2)}const Re=!0;function He(){return V(Re)}function Ae(){return JSON.stringify(He(),null,2)}function Me(){return`// ./vitest.config.ts
