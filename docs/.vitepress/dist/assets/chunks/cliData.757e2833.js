const v={vueTwViteTs:"Vue 3, Tailwind CSS, Headless UI, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Headless UI, Pinia, Markdown, Auto-Loading & Typescript",vueTwNuxt3:"Vue 3, Nuxt 3, Nuxt Content, Tailwind CSS, Headless UI, Pinia, & Typescript"};function R(){return`---
title: Page A
meta:
  - name: description
...
`}function x(e=""){return`<!-- ./src/pages/${e}.vue -->
...
`}function fe(){return x("[...all]")}function ge(){return`<!-- ./src/components/Counter.vue -->
...
`}function Pe(){return x("NotFound404")}function Fe(){return`// ./src/store/root.ts
...
`}function V(e=!1){return`// ./tailwind.config.cjs
...
`}function y(e=!1){let o=["node","vite/client"];return e===!0&&o.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:o,paths:{"@/":["/src"]}}}}const je=!1;function Re(){return y(je)}function Ge(){return JSON.stringify(Re(),null,2)}const He=!0;function Ie(){return y(He)}function Ae(){return JSON.stringify(Ie(),null,2)}function Me(){return`// ./vitest.config.ts
...
`}function k(e=!1){return`<!-- ${e?"./components/Vv/Anchor.vue":"./src/components/vv/anchors/VvAnchor.vue"} -->
...
`}function w(){return C(!1)}function S(){return C(!0)}function Je(){return`<!-- ./src/components/vv/forms/VvFormGroup.vue -->
...
`}function Ne(){return`<!-- ./src/components/vv/selects/VvListbox.vue -->
...
`}function T(e=!1){let o="import '../../../../src/fontAwesome'";return e===!0&&(o="import '../../../../src/fontAwesomePro'"),`// ./tests/components/vv/elements/VvFa.test.js
...
`}function ct(){return T(!1)}function dt(){return T(!0)}function vt(){return`// ./tests/components/vv/forms/VvFormGroup.test.js
