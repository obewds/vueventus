const i={vueTwViteTs:"Vue 3, Tailwind CSS, Headless UI, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Headless UI, Pinia, Markdown, Auto-Loading & Typescript",vueTwNuxt3:"Nuxt 3, Vue 3, Tailwind CSS, Headless UI, Pinia, Nuxt Content, & Typescript"};function oe(){return`---
title: Page A
meta:
  - name: description
...
`}function Ae(){return P("[...all]")}function Re(){return`<!-- ./src/components/Counter.vue -->
...
`}function B(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const rt=!1;function at(){return B(rt)}function lt(){return JSON.stringify(at(),null,2)}const nt=!0;function it(){return B(nt)}function pt(){return JSON.stringify(it(),null,2)}function ut(){return`// ./vitest.config.ts
...
`}function G(){return R(!1)}function $(){return`<!-- ./components/Vv/Fa.vue -->
...
`}function M(){return R(!0)}function E(e=!1){return`<!-- ${e?"./components/Vv/FormGroup.vue":"./src/components/vv/forms/VvFormGroup.vue"} -->
...
`}function N(e=!1){return`<!-- ${e?"./components/Vv/Radio.vue":"./src/components/vv/inputs/VvRadio.vue"} -->
...
`}function Z(){return X(!1)}function kt(){return X(!0)}function wt(){return`// ./tests/components/vv/forms/VvFormGroup.test.js
