const d={vueTwViteTs:"Vue 3, Tailwind CSS, Headless UI, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Headless UI, Pinia, Markdown, Auto-Loading & Typescript"};function D(){return`---
title: Page A
meta:
  - name: description
...
`}function Ie(){return`<!-- ./src/components/vv/anchors/VvAnchor.vue -->
...
`}function Me(){return`<!-- ./src/components/vv/inputs/VvCheckbox.vue -->
...
`}function k(){return y(!1)}function C(){return y(!0)}function Oe(){return`<!-- ./src/components/vv/forms/VvFormGroup.vue -->
...
`}function Ue(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function Je(){return`<!-- ./src/components/vv/lists/VvList.vue -->
...
`}function pt(){return`// ./tests/components/vv/buttons/VvColorModeButton.test.js
...
`}function nt(){return`// ./tests/components/vv/elements/VvEl.test.js
...
`}function it(){return w(!1)}function ut(){return w(!0)}function ct(){return`// ./tests/components/vv/forms/VvFormGroup.test.js
