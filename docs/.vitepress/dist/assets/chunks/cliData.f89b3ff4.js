...
`}function R(e=!1){return`<!-- ${e?"./components/Vv/Button.vue":"./src/components/vv/buttons/VvButton.vue"} -->
...
`}function I(e=!1){return`<!-- ${e?"./components/Vv/Checkbox.vue":"./src/components/vv/inputs/VvCheckbox.vue"} -->
...
<script lang="ts">
    ...
    import VvPrismVars from '${e?"./VvPrismVars.vue":"./PrismVars.vue"}'
    import appColors from '${e?"../../app.colors.json":"../../../app.colors.json"}'
    import appVv from '${e?"../../app.vv":"../../../app.vv"}'
...
`}function Rt(){return`// ./tests/components/vv/selects/VvSelect.test.js
...
`}function It(){return`// ./tests/components/vv/textareas/VvTextarea.test.js
