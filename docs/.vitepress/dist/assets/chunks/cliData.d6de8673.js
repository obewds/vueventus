const n={vueTwViteTs:"Vue 3, Tailwind CSS, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Pinia, Markdown, Auto-Loading & Typescript"};function x(){return`---
title: Page A
meta:
  - name: description
...
`}function F(){return`// ./src/app.vv.ts
...
`}function P(){return`<!-- ./src/pages/b.vue -->
...
`}function j(){return l("[...all]")}function A(){return`<!-- ./src/components/Counter.vue -->
...
`}function H(){return`// ./src/fontAwesomePro.ts
...
`}function M(){return`// ./src/fontawesome.ts
...
`}function E(){return`<!-- ./src/pages/Home.vue -->
...
`}function N(){return l("NotFound404")}function G(){return`// ./src/store/root.ts
...
`}function u(e=!1){return`// ./tailwind.config.cjs
...
`}function c(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const Y=!1;function $(){return c(Y)}function K(){return JSON.stringify($(),null,2)}const Q=!0;function X(){return c(Q)}function Z(){return JSON.stringify(X(),null,2)}function ee(){return`// ./vitest.config.ts
...
`}function te(){return`<!-- ./src/components/vv/anchors/VvAnchor.vue -->
...
`}function se(){return`<!-- ./src/components/vv/inputs/VvCheckbox.vue -->
...
`}function m(){return v(!1)}function d(){return v(!0)}function ae(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function pe(){return`<!-- ./src/components/vv/lists/VvListItem.vue -->
...
`}function ue(){return`<!-- ./src/components/vv/inputs/VvRadio.vue -->
...
`}function ce(){return`<!-- ./src/components/vv/anchors/VvRouterLink.vue -->
...
`}function ve(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function me(){return`<!-- ./src/components/vv/textareas/VvTextarea.vue -->
...
`}function de(){return`// ./tests/pages/b.test.js
...
`}function fe(){return`// ./tests/pages/Home.test.js
...
`}function he(){return`// ./tests/components/vv/anchors/VvAnchor.test.js
...
`}function Ve(){return`// ./tests/components/vv/buttons/VvButton.test.js
...
`}function be(){return`// ./tests/components/vv/inputs/VvCheckbox.test.js
...
`}function we(){return f(!1)}function xe(){return f(!0)}function Ce(){return`// ./tests/components/vv/inputs/VvInput.test.js
...
`}function Se(){return`// ./tests/components/vv/lists/VvListItem.test.js
...
`}function Te(){return`// ./tests/components/vv/elements/VvPrism.test.js
...
`}function Fe(){return`// ./tests/components/vv/elements/VvPrismVars.test.js
...
`}function Be(){return`// ./tests/components/vv/inputs/VvRadio.test.js
...
`}function Pe(){return`// ./tests/components/vv/anchors/VvRouterLink.test.js
...
`}function je(){return`// ./tests/components/vv/buttons/VvScrollUp.test.js
...
`}function Ae(){return`// ./tests/components/vv/textareas/VvTextarea.test.js
