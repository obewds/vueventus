const o={vueTwViteTs:"Vue 3, Tailwind CSS, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Pinia, Markdown, Auto-Loading & Typescript"};function p(){return`---
title: Page A
meta:
  - name: description
...
`}function d(){return`// ./src/app.vv.ts
...
`}function g(){return`<!-- ./src/components/Counter.vue -->
...
`}function b(){return`// ./src/fontawesome.ts
...
`}function k(){return`// ./tests/components/HelloVueVentus.test.js
...
`}function y(){return`<!-- ./src/components/HelloVueVentus.vue -->
...
`}function w(){return`<!-- ./src/components/HelloWorld.vue -->
...
`}function C(){return`<!-- ./src/pages/Home.vue -->
...
`}function x(){return`<!DOCTYPE html>
<html lang="en">
...
`}function T(){return`<!-- ./src/components/MousePos.vue -->
...
`}function F(){return`<!-- ./src/pages/NotFound404.vue -->
...
`}function B(){return`// ./src/store/root.ts
...
`}function P(){return`// ./postcss.config.cjs
...
`}function H(){return`/* ./src/css/prism-theme-vars.css */

@import "prism-theme-vars/base.css";

`}function A(){return`// ./src/router/routes.ts
...
`}function i(e=!1){return`// ./tailwind.config.cjs
...
`}function j(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function l(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const M=!1;function z(){return l(M)}function I(){return JSON.stringify(z(),null,2)}const R=!0;function E(){return l(R)}function L(){return JSON.stringify(E(),null,2)}function D(){return`// ./vitest.config.ts
...
`}function U(){return`<!-- ./src/components/vv/anchors/VvAnchor.vue -->
...
`}function G(){return`<!-- ./src/components/vv/buttons/VvButton.vue -->
...
`}function q(){return`<!-- ./src/components/vv/inputs/VvCheckbox.vue -->
...
`}function N(){return`<!-- ./src/components/vv/buttons/VvColorModeButton.vue -->
...
`}function J(){return`<!-- ./src/components/vv/elements/VvEl.vue -->
...
`}function r(){return`<!-- ./src/components/vv/elements/VvFa.vue -->
...
`}function O(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function W(){return`<!-- ./src/components/vv/lists/VvListItem.vue -->
...
`}function Y(){return`<!-- ./src/components/vv/elements/VvPrismVars.vue -->
...
`}function _(){return`<!-- ./src/components/vv/elements/VvPrism.vue -->
...
`}function $(){return`<!-- ./src/components/vv/inputs/VvRadio.vue -->
...
`}function K(){return`<!-- ./src/components/vv/anchors/VvRouterLink.vue -->
...
`}function Q(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function X(){return`<!-- ./src/components/vv/textareas/VvTextarea.vue -->
...
`}let s={appVvTs:{name:"app.vv.ts",checked:!0,path:"/src/",src:d()},appColorsJson:{name:"app.colors.json",checked:!0,path:"/src/",src:c()},indexHtml:{name:"index.html",checked:!0,path:"/",src:x()},postCssConfigCjs:{name:"postcss.config.cjs",checked:!0,path:"/",src:P()},tailwindCss:{name:"tailwind.css",checked:!0,path:"/src/css/",src:j()}},Z={appVue:{name:"App.vue",checked:!0,path:"/src/",src:u()},homeVue:{name:"Home.vue",checked:!0,path:"/src/pages/",src:C()},notFound404Vue:{name:"NotFound404.vue",checked:!0,path:"/src/pages/",src:F()},routesTs:{name:"routes.ts",checked:!0,path:"/src/router/",src:A()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:i(!1)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:I()},vvRouterLinkVue:{name:"VvRouterLink.vue",checked:!0,path:"/src/components/vv/anchors/",src:K()}},ee={appVue:{name:"App.vue",checked:!0,path:"/src/",src:v()},aMd:{name:"a.md",checked:!0,path:"/src/pages/",src:p()},bMd:{name:"b.md",checked:!0,path:"/src/pages/",src:m()},bVue:{name:"b.vue",checked:!0,path:"/src/pages/nested/deep/",src:f()},counterVue:{name:"Counter.vue",checked:!0,path:"/src/components/",src:g()},helloWorldVueSsg:{name:"HelloWorld.vue",checked:!0,path:"/src/components/",src:w()},indexMd:{name:"index.md",checked:!0,path:"/src/pages/",src:S()},mousePosVue:{name:"MousePos.vue",checked:!0,path:"/src/components/",src:T()},piniaRootTs:{name:"root.ts",checked:!0,path:"/src/store/",src:B()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:i(!0)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:L()}},a={vvAnchorVue:{name:"VvAnchor.vue",checked:!0,path:"/src/components/vv/anchors/",src:U()},vvButtonVue:{name:"VvButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:G()},vvCheckboxVue:{name:"VvCheckbox.vue",checked:!0,path:"/src/components/vv/inputs/",src:q()},vvColorModeButtonVue:{name:"VvColorModeButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:N()},vvElVue:{name:"VvEl.vue",checked:!0,path:"/src/components/vv/elements/",src:J()},vvInputVue:{name:"VvInput.vue",checked:!0,path:"/src/components/vv/inputs/",src:O()},vvListItemVue:{name:"VvListItem.vue",checked:!0,path:"/src/components/vv/lists/",src:W()},vvRadioVue:{name:"VvRadio.vue",checked:!0,path:"/src/components/vv/inputs/",src:$()},vvTextareaVue:{name:"VvTextarea.vue",checked:!0,path:"/src/components/vv/textareas/",src:X()}},n={fontawesome:{checked:!0,name:"FontAwesome Free",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/free-solid-svg-icons @fortawesome/free-regular-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/free-solid-svg-icons","@fortawesome/free-regular-svg-icons"],files:{fontAwesomeTs:{name:"fontAwesome.ts",checked:!0,path:"/src/",src:b()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:r()}}},faPro:{checked:!1,name:"FontAwesome Pro (License Required)",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/pro-duotone-svg-icons @fortawesome/pro-light-svg-icons @fortawesome/pro-regular-svg-icons @fortawesome/pro-solid-svg-icons @fortawesome/pro-thin-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/pro-solid-svg-icons","@fortawesome/pro-regular-svg-icons","@fortawesome/pro-duotone-svg-icons","@fortawesome/pro-light-svg-icons","@fortawesome/pro-thin-svg-icons"],files:{fontAwesomeProTs:{name:"fontAwesomePro.ts",checked:!0,path:"/src/",src:h()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:r()}}},gsap:{checked:!0,name:"GSAP",install:"npm install gsap --save-dev",packages:["gsap"],files:{gsapTs:{name:"gsap.ts",checked:!0,path:"/src/",src:V()},vvScrollUp:{name:"VvScrollUp.vue",checked:!0,path:"/src/components/vv/buttons/",src:Q()}}},headless:{checked:!0,name:"Headless UI",install:"npm install @headlessui/vue --save-dev",packages:["@headlessui/vue"],files:{}},heroicons:{checked:!0,name:"Heroicons",install:"npm install @heroicons/vue --save-dev",packages:["@heroicons/vue"],files:{}},prism:{checked:!0,name:"Prism.js",install:"npm install prismjs vite-plugin-prismjs @types/prismjs prism-theme-vars --save-dev",packages:["prismjs","vite-plugin-prismjs","@types/prismjs","prism-theme-vars"],files:{vvPrism:{name:"VvPrism.vue",checked:!0,path:"/src/components/vv/elements/",src:_()},prismThemeVarsCss:{name:"prism-theme-vars.css",checked:!0,path:"/src/css/",src:H()},VvPrismVars:{name:"VvPrismVars.vue",checked:!0,path:"/src/components/vv/elements/",src:Y()}}},vitest:{checked:!0,name:"Vitest",install:"npm install vitest @vue/test-utils happy-dom @vitest/coverage-c8 --save-dev",packages:["vitest","@vue/test-utils","happy-dom","@vitest/coverage-c8"],files:{vitestConfigTs:{name:"vitest.config.ts",checked:!0,path:"/",src:D()},helloVueVentusTestJs:{name:"HelloVueVentus.test.js",checked:!0,path:"/tests/components/",src:k()},helloVueVentusVue:{name:"HelloVueVentus.vue",checked:!0,path:"/src/components/",src:y()}}}};const oe={stacks:{vueTwViteTs:{name:o.vueTwViteTs,files:{...s,...Z},deps:{...n},compos:{...a}},vueTwViteSsgMdTs:{name:o.vueTwViteSsgMdTs,files:{...s,...ee},deps:{...n},compos:{...a}}}};export{oe as c};
