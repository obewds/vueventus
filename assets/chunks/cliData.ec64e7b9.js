...
`}function d(){return`<!-- ./src/pages/b.vue -->
...
`}function k(){return`<!-- ./src/components/HelloWorld.vue -->
...
`}function i(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const j=!1;function A(){return i(j)}function M(){return JSON.stringify(A(),null,2)}const H=!0;function I(){return i(H)}function E(){return JSON.stringify(I(),null,2)}function L(){return`// ./vitest.config.ts
...
`}function R(){return`<!-- ./src/components/vv/buttons/VvColorModeButton.vue -->
...
`}function G(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function q(){return`<!-- ./src/components/vv/elements/VvPrismVars.vue -->
...
`}function O(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function U(){return`<!-- ./src/components/vv/textareas/VvTextarea.vue -->
