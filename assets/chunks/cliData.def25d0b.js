...
`}function i(e=!1){let t=["node","vite/client"];return e===!0&&t.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:t,paths:{"@/":["/src"]}}}}const j=!1;function H(){return i(j)}function A(){return JSON.stringify(H(),null,2)}const M=!0;function I(){return i(M)}function E(){return JSON.stringify(I(),null,2)}function z(){return`// ./vitest.config.ts
...
`}function D(){return`<!-- ./src/components/vv/buttons/VvButton.vue -->
...
`}function R(){return`<!-- ./src/components/vv/inputs/VvCheckbox.vue -->
...
`}function G(){return`<!-- ./src/components/vv/buttons/VvColorModeButton.vue -->
...
`}function W(){return`<!-- ./src/components/vv/elements/VvEl.vue -->
...
`}function J(){return`<!-- ./src/components/vv/lists/VvListItem.vue -->
...
`}function N(){return`<!-- ./src/components/vv/elements/VvPrismVars.vue -->
...
`}function O(){return`<!-- ./src/components/vv/elements/VvPrism.vue -->
...
`}function U(){return`<!-- ./src/components/vv/inputs/VvRadio.vue -->
