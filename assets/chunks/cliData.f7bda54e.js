import{V as e}from"./VvConfig.bdebbb43.js";const n={vueTwViteTs:"Vue 3, Tailwind CSS, Vue Router, Vite & Typescript",vueTwViteSsgMdTs:"Vite-SSG, Vue 3, Tailwind CSS, Pinia, Markdown, Auto-Loading & Typescript"};function C(){return`---
title: Page A
meta:
  - name: description
...
`}function B(){return`// ./src/app.vv.ts
...
// appVv.defaults['VvInput'].size = '${e.defaults.VvInput.size}'
...
//     default: '${e.anchors.palettes.default.default}',
//     error: '${e.anchors.palettes.default.error}',
//     primary: '${e.anchors.palettes.default.primary}',
//     secondary: '${e.anchors.palettes.default.secondary}',
//     success: '${e.anchors.palettes.default.success}',
// }

// appVv.borders.palettes.default = {
//     '': '',
//     default: '${e.borders.palettes.default.default}',
//     error: '${e.borders.palettes.default.error}',
//     primary: '${e.borders.palettes.default.primary}',
//     secondary: '${e.borders.palettes.default.secondary}',
//     success: '${e.borders.palettes.default.success}',
// }
...
//     default: '${e.buttons.palettes.outline.default}',
//     error: '${e.buttons.palettes.outline.error}',
//     primary: '${e.buttons.palettes.outline.primary}',
//     secondary: '${e.buttons.palettes.outline.secondary}',
//     success: '${e.buttons.palettes.outline.success}',
// }

// appVv.buttons.palettes.solid = {
//     default: '${e.buttons.palettes.solid.default}',
//     error: '${e.buttons.palettes.solid.error}',
//     primary: '${e.buttons.palettes.solid.primary}',
//     secondary: '${e.buttons.palettes.solid.secondary}',
//     success: '${e.buttons.palettes.solid.success}',
// }

// appVv.buttons.palettes.default = appVv.buttons.palettes.solid

// appVv.checkboxes.palettes.default = {
//     default: '${e.checkboxes.palettes.default.default}',
//     error: '${e.checkboxes.palettes.default.error}',
//     primary: '${e.checkboxes.palettes.default.primary}',
//     secondary: '${e.checkboxes.palettes.default.secondary}',
//     success: '${e.checkboxes.palettes.default.success}',
// }
...
//     default: '${e.grounds.palettes.console.default}',
//     error: '${e.grounds.palettes.console.error}',
//     primary: '${e.grounds.palettes.console.primary}',
//     secondary: '${e.grounds.palettes.console.secondary}',
//     success: '${e.grounds.palettes.console.success}',
// }

// appVv.grounds.palettes.default = {
//     default: '${e.grounds.palettes.default.default}',
//     error: '${e.grounds.palettes.default.error}',
//     primary: '${e.grounds.palettes.default.primary}',
//     secondary: '${e.grounds.palettes.default.secondary}',
//     success: '${e.grounds.palettes.default.success}',
// }

// appVv.grounds.palettes.monochromatic = {
//     default: '${e.grounds.palettes.monochromatic.default}',
//     error: '${e.grounds.palettes.monochromatic.error}',
//     primary: '${e.grounds.palettes.monochromatic.primary}',
//     secondary: '${e.grounds.palettes.monochromatic.secondary}',
//     success: '${e.grounds.palettes.monochromatic.success}',
// }

// appVv.grounds.palettes.pastel = {
//     default: '${e.grounds.palettes.pastel.default}',
//     error: '${e.grounds.palettes.pastel.error}',
//     primary: '${e.grounds.palettes.pastel.primary}',
//     secondary: '${e.grounds.palettes.pastel.secondary}',
//     success: '${e.grounds.palettes.pastel.success}',
// }
...
//     default: '${e.inputs.palettes.default.default}',
//     error: '${e.inputs.palettes.default.error}',
//     success: '${e.inputs.palettes.default.success}',
// }

// appVv.inputs.palettes.underlined = {
//     default: '${e.inputs.palettes.underlined.default}',
//     error: '${e.inputs.palettes.underlined.error}',
//     success: '${e.inputs.palettes.underlined.success}',
// }

// appVv.radios.palettes.default = {
//     default: '${e.radios.palettes.default.default}',
//     error: '${e.radios.palettes.default.error}',
//     primary: '${e.radios.palettes.default.primary}',
//     secondary: '${e.radios.palettes.default.secondary}',
//     success: '${e.radios.palettes.default.success}',
// }
...
//     default: '${e.text.palettes.default.default}',
//     error: '${e.text.palettes.default.error}',
//     primary: '${e.text.palettes.default.primary}',
//     secondary: '${e.text.palettes.default.secondary}',
//     success: '${e.text.palettes.default.success}',
//     neutral: '${e.text.palettes.default.neutral}',
// }
...
`}function j(){return`<!-- ./src/pages/b.vue -->
...
`}function u(t=""){return`<!-- ./src/pages/${t}.vue -->
...
`}function A(){return u("[...all]")}function R(){return`<!-- ./src/components/Counter.vue -->
...
`}function M(){return`// ./src/fontAwesomePro.ts
...
`}function H(){return`// ./src/fontawesome.ts
...
`}function I(){return`// ./tests/components/HelloVueVentus.test.js
...
`}function z(){return`<!-- ./src/components/HelloVueVentus.vue -->
...
`}function E(){return`<!-- ./src/components/HelloWorld.vue -->
...
`}function $(){return`<!-- ./src/pages/Home.vue -->
...
`}function J(){return`<!DOCTYPE html>
<html lang="en">
...
`}function U(){return`<!-- ./src/components/MousePos.vue -->
...
`}function G(){return u("NotFound404")}function N(){return`// ./src/store/root.ts
...
`}function q(){return`// ./postcss.config.cjs
...
`}function O(){return`/* ./src/css/prism-theme-vars.css */

@import "prism-theme-vars/base.css";

`}function W(){return`// ./src/router/routes.ts
...
`}function c(t=!1){return`// ./tailwind.config.cjs
...
module.exports = {
    ...
    content: [
        "./index.html",
        ${t===!0?'"./src/**/*.{md,html,vue,js,ts,jsx,tsx}",':'"./src/**/*.{vue,js,ts,jsx,tsx}",'}
...
`}function _(){return`/* ./src/css/tailwind.css */

@tailwind base;
@tailwind components;
@tailwind utilities;

`}function v(t=!1){let o=["node","vite/client"];return t===!0&&o.push("vite-plugin-pages/client"),{compilerOptions:{allowJs:!0,types:o,paths:{"@/":["/src"]}}}}const Y=!1;function K(){return v(Y)}function Q(){return JSON.stringify(K(),null,2)}const X=!0;function Z(){return v(X)}function ee(){return JSON.stringify(Z(),null,2)}function te(){return`// ./vitest.config.ts
...
`}function oe(){return`<!-- ./src/components/vv/anchors/VvAnchor.vue -->
...
`}function se(){return`<!-- ./src/components/vv/buttons/VvButton.vue -->
...
`}function re(){return`<!-- ./src/components/vv/inputs/VvCheckbox.vue -->
...
`}function ae(){return`<!-- ./src/components/vv/buttons/VvColorModeButton.vue -->
...
`}function ne(){return`<!-- ./src/components/vv/elements/VvEl.vue -->
...
`}function m(t=!1){const o=`
    <FontAwesomeIcon :icon="[family, icon]" :size="size"/>
`;let a=o;return t===!0&&(a=o),`<!-- ./src/components/vv/elements/VvFa.vue -->
...
`}function d(){return m(!1)}function f(){return m(!0)}function pe(){return`<!-- ./src/components/vv/inputs/VvInput.vue -->
...
`}function ue(){return`<!-- ./src/components/vv/elements/VvPrism.vue -->
...
`}function ce(){return`<!-- ./src/components/vv/inputs/VvRadio.vue -->
...
`}function ve(){return`<!-- ./src/components/vv/anchors/VvRouterLink.vue -->
...
`}function me(){return`<!-- ./src/components/vv/buttons/VvScrollUp.vue -->
...
`}function fe(){return`// ./tests/pages/b.test.js
...
`}function ge(){return`// ./tests/pages/Home.test.js
...
`}function he(){return`// ./tests/pages/NotFound404.test.js
...
`}function Ve(){return`// ./tests/components/vv/anchors/VvAnchor.test.js
...
`}function be(){return`// ./tests/components/vv/buttons/VvButton.test.js
...
`}function ye(){return`// ./tests/components/vv/inputs/VvCheckbox.test.js
...
`}function ke(){return`// ./tests/components/vv/buttons/VvColorModeButton.test.js
...
`}function xe(){return`// ./tests/components/vv/elements/VvEl.test.js
...
`}function g(t=!1){let o="import '../../../../src/fontAwesome'";return t===!0&&(o="import '../../../../src/fontAwesomePro'"),`// ./tests/components/vv/elements/VvFa.test.js
...
`}function we(){return g(!1)}function Ce(){return g(!0)}function Se(){return`// ./tests/components/vv/inputs/VvInput.test.js
...
`}function Te(){return`// ./tests/components/vv/lists/VvListItem.test.js
...
`}function Fe(){return`// ./tests/components/vv/elements/VvPrism.test.js
...
`}function Be(){return`// ./tests/components/vv/elements/VvPrismVars.test.js
...
`}function Pe(){return`// ./tests/components/vv/inputs/VvRadio.test.js
...
`}function je(){return`// ./tests/components/vv/anchors/VvRouterLink.test.js
...
`}function Ae(){return`// ./tests/components/vv/buttons/VvScrollUp.test.js
...
`}function Re(){return`// ./tests/components/vv/textareas/VvTextarea.test.js
...
`}let l={appVvTs:{name:"app.vv.ts",checked:!0,path:"/src/",src:B()},appColorsJson:{name:"app.colors.json",checked:!0,path:"/src/",src:S()},indexHtml:{name:"index.html",checked:!0,path:"/",src:J()},postCssConfigCjs:{name:"postcss.config.cjs",checked:!0,path:"/",src:q()},tailwindCss:{name:"tailwind.css",checked:!0,path:"/src/css/",src:_()}},Me={appVue:{name:"App.vue",checked:!0,path:"/src/",src:T()},homeVue:{name:"Home.vue",checked:!0,path:"/src/pages/",src:$()},notFound404Vue:{name:"NotFound404.vue",checked:!0,path:"/src/pages/",src:G()},routesTs:{name:"routes.ts",checked:!0,path:"/src/router/",src:W()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:c(!1)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:Q()}},He={appVue:{name:"App.vue",checked:!0,path:"/src/",src:F()},aMd:{name:"a.md",checked:!0,path:"/src/pages/",src:C()},bMd:{name:"b.md",checked:!0,path:"/src/pages/",src:P()},bVue:{name:"b.vue",checked:!0,path:"/src/pages/nested/deep/",src:j()},catchAll404:{name:"[...all].vue",checked:!0,path:"/src/pages/",src:A()},counterVue:{name:"Counter.vue",checked:!0,path:"/src/components/",src:R()},helloWorldVueSsg:{name:"HelloWorld.vue",checked:!0,path:"/src/components/",src:E()},indexMd:{name:"index.md",checked:!0,path:"/src/pages/",src:D()},mousePosVue:{name:"MousePos.vue",checked:!0,path:"/src/components/",src:U()},piniaRootTs:{name:"root.ts",checked:!0,path:"/src/store/",src:N()},tailwindConfigCjs:{name:"tailwind.config.cjs",checked:!0,path:"/",src:c(!0)},tsconfigJson:{name:"tsconfig.json",checked:!0,path:"/",src:ee()}},i={vvAnchorVue:{name:"VvAnchor.vue",checked:!0,path:"/src/components/vv/anchors/",src:oe()},vvButtonVue:{name:"VvButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:se()},vvCheckboxVue:{name:"VvCheckbox.vue",checked:!0,path:"/src/components/vv/inputs/",src:re()},vvColorModeButtonVue:{name:"VvColorModeButton.vue",checked:!0,path:"/src/components/vv/buttons/",src:ae()},vvElVue:{name:"VvEl.vue",checked:!0,path:"/src/components/vv/elements/",src:ne()},vvInputVue:{name:"VvInput.vue",checked:!0,path:"/src/components/vv/inputs/",src:pe()},vvListItemVue:{name:"VvListItem.vue",checked:!0,path:"/src/components/vv/lists/",src:le()},vvRadioVue:{name:"VvRadio.vue",checked:!0,path:"/src/components/vv/inputs/",src:ce()},vvRouterLinkVue:{name:"VvRouterLink.vue",checked:!0,path:"/src/components/vv/anchors/",src:ve()},vvTextareaVue:{name:"VvTextarea.vue",checked:!0,path:"/src/components/vv/textareas/",src:de()}},h={checked:!0,name:"FontAwesome Free",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/free-solid-svg-icons @fortawesome/free-regular-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/free-solid-svg-icons","@fortawesome/free-regular-svg-icons"],files:{fontAwesomeTs:{name:"fontAwesome.ts",checked:!0,path:"/src/",src:H()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:d()},vvFaTestJs:{name:"VvFa.test.js",checked:!0,path:"/tests/components/vv/elements/",src:we()}}},V=h;V.files.vvFa={name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:f()};let b={checked:!1,name:"FontAwesome Pro (License Required)",install:"npm install @fortawesome/fontawesome-svg-core @fortawesome/vue-fontawesome@latest-3 @fortawesome/free-brands-svg-icons @fortawesome/pro-duotone-svg-icons @fortawesome/pro-light-svg-icons @fortawesome/pro-regular-svg-icons @fortawesome/pro-solid-svg-icons @fortawesome/pro-thin-svg-icons @fortawesome/sharp-solid-svg-icons --save-dev",packages:["@fortawesome/fontawesome-svg-core","@fortawesome/vue-fontawesome@latest-3","@fortawesome/free-brands-svg-icons","@fortawesome/pro-solid-svg-icons","@fortawesome/pro-regular-svg-icons","@fortawesome/pro-duotone-svg-icons","@fortawesome/pro-light-svg-icons","@fortawesome/pro-thin-svg-icons","@fortawesome/sharp-solid-svg-icons"],files:{fontAwesomeProTs:{name:"fontAwesomePro.ts",checked:!0,path:"/src/",src:M()},vvFa:{name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:d()},vvFaTestJs:{name:"VvFa.test.js",checked:!0,path:"/tests/components/vv/elements/",src:Ce()}}},y=b;y.files.vvFa={name:"VvFa.vue",checked:!0,path:"/src/components/vv/elements/",src:f()};let k={checked:!0,name:"Vitest",install:"npm install vitest @vue/test-utils happy-dom @vitest/coverage-c8 --save-dev",packages:["vitest","@vue/test-utils","happy-dom","@vitest/coverage-c8"],files:{vitestConfigTs:{name:"vitest.config.ts",checked:!0,path:"/",src:te()},helloVueVentusTestJs:{name:"HelloVueVentus.test.js",checked:!0,path:"/tests/components/",src:I()},helloVueVentusVue:{name:"HelloVueVentus.vue",checked:!0,path:"/src/components/",src:z()},vvAnchorTestJs:{name:"VvAnchor.test.js",checked:!0,path:"/tests/components/vv/anchors/",src:Ve()},vvButtonTestJs:{name:"VvButton.test.js",checked:!0,path:"/tests/components/vv/buttons/",src:be()},vvCheckboxTestJs:{name:"VvCheckbox.test.js",checked:!0,path:"/tests/components/vv/inputs/",src:ye()},vvColorModeButtonTestJs:{name:"VvColorModeButton.test.js",checked:!0,path:"/tests/components/vv/buttons/",src:ke()},vvElTestJs:{name:"VvEl.test.js",checked:!0,path:"/tests/components/vv/elements/",src:xe()},vvInputTestJs:{name:"VvInput.test.js",checked:!0,path:"/tests/components/vv/inputs/",src:Se()},vvListItemTestJs:{name:"VvListItem.test.js",checked:!0,path:"/tests/components/vv/lists/",src:Te()},vvRadioTestJs:{name:"VvRadio.test.js",checked:!0,path:"/tests/components/vv/inputs/",src:Pe()},vvRouterLinkTestJs:{name:"VvRouterLink.test.js",checked:!0,path:"/tests/components/vv/anchors/",src:je()},vvScrollUpTestJs:{name:"VvScrollUp.test.js",checked:!0,path:"/tests/components/vv/buttons/",src:Ae()},vvTextareaTestJs:{name:"VvTextarea.test.js",checked:!0,path:"/tests/components/vv/textareas/",src:Re()}}},p=k;p.files.homeTestJs={name:"Home.test.js",checked:!0,path:"/tests/pages/",src:ge()};p.files.notFound404TestJs={name:"NotFound404.test.js",checked:!0,path:"/tests/pages/",src:he()};let x=k;x.files.bTestJs={name:"b.test.js",checked:!0,path:"/tests/pages/",src:fe()};let w={fontawesome:{},faPro:{},gsap:{checked:!0,name:"GSAP",install:"npm install gsap --save-dev",packages:["gsap"],files:{gsapTs:{name:"gsap.ts",checked:!0,path:"/src/",src:L()},vvScrollUp:{name:"VvScrollUp.vue",checked:!0,path:"/src/components/vv/buttons/",src:me()}}},headless:{checked:!0,name:"Headless UI",install:"npm install @headlessui/vue --save-dev",packages:["@headlessui/vue"],files:{}},heroicons:{checked:!0,name:"Heroicons",install:"npm install @heroicons/vue --save-dev",packages:["@heroicons/vue"],files:{}},prism:{checked:!0,name:"Prism.js",install:"npm install prismjs vite-plugin-prismjs @types/prismjs prism-theme-vars --save-dev",packages:["prismjs","vite-plugin-prismjs","@types/prismjs","prism-theme-vars"],files:{vvPrism:{name:"VvPrism.vue",checked:!0,path:"/src/components/vv/elements/",src:ue()},prismThemeVarsCss:{name:"prism-theme-vars.css",checked:!0,path:"/src/css/",src:O()},VvPrismVars:{name:"VvPrismVars.vue",checked:!0,path:"/src/components/vv/elements/",src:ie()},vvPrismTestJs:{name:"VvPrism.test.js",checked:!0,path:"/tests/components/vv/elements/",src:Fe()},vvPrismVarsTestJs:{name:"VvPrismVars.test.js",checked:!0,path:"/tests/components/vv/elements/",src:Be()}}},vitest:{}},s=w;s.fontawesome=h;s.faPro=b;s.vitest=p;let r=w;r.fontawesome=V;r.faPro=y;r.vitest=x;const Ie={stacks:{vueTwViteTs:{name:n.vueTwViteTs,files:{...l,...Me},deps:{...s},compos:{...i}},vueTwViteSsgMdTs:{name:n.vueTwViteSsgMdTs,files:{...l,...He},deps:{...r},compos:{...i}}}};export{Ie as c};
