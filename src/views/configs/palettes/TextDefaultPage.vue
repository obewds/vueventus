<!-- ./src/views/configs/palettes/TextDefaultPage.vue -->

<script setup lang="ts">

    import globals from '../../../globals'
    import TextDefault from '../../../configs/palettes/TextDefault'
...
<template>
    ...
    <DevViewArticle title="TextDefault Palette Config Module">
