...
export default {
    classes: {
        ...
        gridCardLink: 'bg-emerald-600 hover:bg-emerald-700 text-white p-6 rounded-xl drop-shadow-md cursor-pointer ' + Transitions.classes(),
        gridCardLinkModule: 'bg-amber-600 hover:bg-amber-700 text-white p-6 rounded-xl drop-shadow-md cursor-pointer ' + Transitions.classes(),
        gridCardLinkPalette: 'bg-indigo-600 hover:bg-indigo-700 text-white p-6 rounded-xl drop-shadow-md cursor-pointer ' + Transitions.classes(),
